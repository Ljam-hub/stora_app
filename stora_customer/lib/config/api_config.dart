...
class ApiConfig {
  ...
  /// Secondary Wi-Fi LAN IP fallback
  ...
  static void setCustomUrl(String? url) {
    ...
    debugPrint('ApiConfig customUrl set to: $_customUrl, baseUrl: $baseUrl');
  }
  ...
  static Future<bool> resolve() async {
    ...
    baseUrl = _customUrl ?? candidateList.first;
    debugPrint('ApiConfig fallback baseUrl: $baseUrl (server not answering)');
    return false;
  }
